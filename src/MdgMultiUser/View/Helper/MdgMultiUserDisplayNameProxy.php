...
class MdgMultiUserDisplayNameProxy extends AbstractHelper implements ServiceLocatorAwareInterface
{
    /**
    ...
    {
        if ($alias) {
            $pluginName = 'mdgmultiuser.user_display_name_helper.' . $alias;
            ...
            $plugin = $this->getServiceLocator()->get('zfcUserDisplayName');
            return $plugin();
        }
    }
}
