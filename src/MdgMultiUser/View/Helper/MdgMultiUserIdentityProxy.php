...
class MdgMultiUserIdentityProxy extends AbstractHelper implements ServiceLocatorAwareInterface
{
    /**
    ...
    {
        if ($alias) {
            $pluginName = 'mdgmultiuser.user_identity_helper.' . $alias;
            ...
            $plugin = $this->getServiceLocator()->get('zfcUserIdentity');
            return $plugin();
        }
    }
}
